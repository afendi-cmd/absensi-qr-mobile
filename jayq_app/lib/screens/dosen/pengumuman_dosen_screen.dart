...
import '../mahasiswa/pengumuman_detail_screen.dart';

class PengumumanDosenScreen extends StatefulWidget {
  const PengumumanDosenScreen({super.key});

  @override
  State<PengumumanDosenScreen> createState() => _PengumumanDosenScreenState();
}

class _PengumumanDosenScreenState extends State<PengumumanDosenScreen> {
